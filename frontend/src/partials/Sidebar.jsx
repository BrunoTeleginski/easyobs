...
function Sidebar({ sidebarOpen, setSidebarOpen }) {
  ...
  function setMenuActive(currentPath){
    return pathname == currentPath && "text-indigo-500"
  }
              ...
              <li className={`px-3 py-2 rounded-sm mb-0.5 last:mb-0 ${pathname.includes('messages') && 'bg-slate-900'}`}>
                ...
                >
                  <div className="flex items-center justify-between hover:underline">
                    <div className={`grow flex items-center ${setMenuActive("/")}`}>
                    ...
                    {/* <div className="flex flex-shrink-0 ml-2">
                      <span className="inline-flex items-center justify-center h-5 text-xs font-medium text-white bg-indigo-500 px-2 rounded">3</span>
                    </div> */}
                  </div>
                </NavLink>
              </li>
